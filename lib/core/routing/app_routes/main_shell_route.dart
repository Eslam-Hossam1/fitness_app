...
class MainShellRoute {
  ...
  static final GlobalKey<NavigatorState> _trainersNavigatorKey =
      GlobalKey<NavigatorState>(debugLabel: 'trainersNav');
  static final GlobalKey<NavigatorState> _plansNavigatorKey =
      GlobalKey<NavigatorState>(debugLabel: 'plansNav');
  static final GlobalKey<NavigatorState> _favoritesNavigatorKey =
      GlobalKey<NavigatorState>(debugLabel: 'favNav');
        ...
        routes: [
          GoRoute(
            ...
            builder: (context, state) => BlocProvider(
              create: (context) =>
                  FeaturedPlansCubit(getIt<FeaturedPlansRepo>())
                    ..getFeaturedPlans(),
